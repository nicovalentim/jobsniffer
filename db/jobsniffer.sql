...
INSERT INTO `banco_de_vagas` VALUES (1,'Desenvolvedor Front-End','Criação interfaces responsivas','React, HTML, CSS, JavaScript',7500.00,'Remoto','2026-03-17 19:42:32','TI'),(2,'Analista de Suporte Técnico','Atendimento a usuários e manutenção','Windows, Redes, Hardware',3500.00,'Híbrido','2026-03-17 19:42:32','TI'),(3,'Administrador de Banco de Dados (DBA)','Gestão e otimização de bancos MySQL','SQL Avançado, Backup, Performance',9000.00,'Remoto','2026-03-17 19:42:32','TI'),(4,'Engenheiro de Redes','Configuração de roteadores e firewalls','Certificação CCNA, Protocolos TCP/IP',8200.00,'Presencial','2026-03-17 19:42:32','TI'),(5,'Analista de Segurança da Informação','Monitoramento de ameaças e vulnerabilidades','LGPD, Firewall, Ethical Hacking',9500.00,'Remoto','2026-03-17 19:42:32','TI'),(6,'Consultor de Sucesso do Cliente (Vendedor)','Prospecção ativa de novos negócios., Diagnóstico de necessidades e apresentação de soluções., Negociação e fechamento de contratos., Gestão de contatos no sistema (CRM)','Pacote Office, Organização',2800.00,'Presencial','2026-03-17 19:42:32','COM'),(7,'Recepcionista','Atendimento telefônico e recepção de clientes','Comunicação assertiva, Inglês básico',2200.00,'Presencial','2026-03-17 19:42:32','ADM'),(8,'Auxiliar Financeiro','Controle de contas a pagar e receber','Matemática financeira, Excel',3000.00,'Híbrido','2026-03-17 19:42:32','ADM'),(9,'Analista Administrativo','Gestão de processos internos e relatórios','Gestão de processos, ERP',2500.00,'Presencial','2026-03-17 19:42:32','ADM'),(10,'Analista de Marketing','Gestão de Campanhas: Criar e monitorar anúncios em redes sociais e Google Ads., Conteúdo: Produzir materiais para blog, e-mail marketing e redes sociais., Análise de Dados: Mensurar KPIs e o ROI das ações de marketing., Branding: Garantir a consistência da identidade visual e voz da marca','Criatividade: Capacidade de propor soluções fora da caixa., Analítico: Domínio de ferramentas como Google Analytics e RD Station/HubSpot., Comunicação: Redação impecável e excelente habilidade interpessoal.',3200.00,'Híbrido','2026-03-17 19:42:32','MKT'),(11,'Analista de Logística','Gestão de Estoque: Controlar entradas e saídas, evitando rupturas ou excessos., Fretes e Transportes: Negociar com transportadoras e roteirizar entregas., Recebimento e Expedição: Supervisionar a conferência física e documental (notas fiscais)., Indicadores (KPIs): Monitorar prazos de entrega (OTIF) e custos operacionais.','Raciocínio Lógico: Facilidade com números e resolução de problemas., Agilidade: Capacidade de tomar decisões rápidas sob pressão., Domínio de Ferramentas: Experiência com sistemas ERP e Excel avançado.',3100.00,'Presencial','2026-03-17 19:42:32','LOG'),(12,'Projetista Mecânico (Equipamentos de Impressão)','Modelagem 3D e 2D: Elaborar projetos detalhados de peças e conjuntos., Especificação: Definir materiais e processos de fabricação (usinagem, montagem)., Melhoria Contínua: Otimizar mecanismos para ganho de performance., Documentação: Criar listas de materiais e manuais técnicos.','Domínio de SolidWorks, AutoCAD ou similar., Conhecimento em normas técnicas e mecânica de precisão., Raciocínio lógico e atenção aos detalhes.',8000.00,'Hibrido','2026-03-17 19:42:32','ENG');
...
-- Dump completed on 2026-03-24 18:04:54
